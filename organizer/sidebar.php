    ...
    <div class="sidebar rounded shadow position-sticky" style="font-weight: 500; top: 2rem;">
        ...
        <div class="d-grid gap-2 p-3 pt-0">
            ...
            <a href="eventlists.php"
                ...
                <i class="fa fa-list me-2"></i> Events
            </a>
            <a href="registrants.php"
                class="d-flex align-items-center text-decoration-none text-black py-2 px-2 rounded hover-shadow<?php echo $current_page == 'registrants.php' ? ' active' : ''; ?>">
